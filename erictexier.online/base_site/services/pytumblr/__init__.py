...
from base_site.services.pytumblr.helpers import validate_params, validate_blogname
from base_site.services.pytumblr.request_tumblr import TumblrRequest
...
class TumblrRestClient(object):
    ...
    @classmethod
    def get_tumblr_client(cls, yaml_path):

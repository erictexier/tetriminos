...
def new_post():
    ...
    return flask.render_template('posts/create_post.html', title='New Post',
                                                legend = 'New Post', 
                                                form= form)
...
def post(post_id):
    ...
    return flask.render_template('posts/post.html', title=post.title, post = post)
...
def update_post(post_id):
    ...
    return flask.render_template('posts/create_post.html',  title='Update Post', 
                                                legend = 'Update Post',
                                                form = form)
